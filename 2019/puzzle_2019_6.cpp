...
} // namepspace puzzle_2019_6

void Solver_2019_6_1::solve(const QString& input)
{
  using namespace puzzle_2019_6;
...
void Solver_2019_6_2::solve(const QString& input)
{
  using namespace puzzle_2019_6;
  const Tree tree(input);
  if (!tree.m_root)
