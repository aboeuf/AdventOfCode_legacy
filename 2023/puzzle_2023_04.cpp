...
inline uint twoPower(const uint power) {
    static auto two_power = QMap<uint, uint> {
        {0u, 1u},
        {1u, 2u}
    };
...
inline uint nbMatchesOnCard(const QString& input) {
    ...
    auto winning_numbers = common::toUIntValues(split_numbers[0], ' ');
    auto candidate_numbers = common::toUIntValues(split_numbers[1], ' ');
    auto nb_matches = 0u;
