...
int ID(int row, int column) { return 8 * row + column; }

bool binaryFind(const QString &boarding_pass, int start, int count,
                const QChar &down, const QChar &up, int &result) {
  int min = 0;
...
bool decodeBoardingPass(const QString &boarding_pass, int &row, int &column,
                        int &id) {
...
void Solver_2020_05_1::solve(const QString &input) {
  using namespace puzzle_2020_05;
...
void Solver_2020_05_2::solve(const QString &input) {
  using namespace puzzle_2020_05;
