...
{
  ui->setupUi(this);
  connect(this, SIGNAL(advanceDays(uint)), m_lobby, SLOT(advanceDays(uint)), Qt::DirectConnection);
  connect(m_lobby, SIGNAL(finished()), this, SLOT(updateDispay()), Qt::DirectConnection);
