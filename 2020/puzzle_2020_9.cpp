...
bool findFirstInvalid(const QString& input, std::size_t preamble_length, int& result)
{
...
void Solver_2020_9_1::solve(const QString& input)
{
  using namespace puzzle_2020_9;
  int result;
...
void Solver_2020_9_2::solve(const QString& input)
{
  using namespace puzzle_2020_9;
  const Data data = readXmasData(input);
  int result;
